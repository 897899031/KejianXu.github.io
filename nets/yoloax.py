...
from .Modified_CSPDarknet import BaseConv, CSPDarknet, CSPAM
...
class YOLOXHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for k, x in enumerate(inputs):
            # ---------------------------------------------------#
            #   Channel integration using 1x1 convolution
            # ---------------------------------------------------#
            x = self.stems[k](x)
            # ---------------------------------------------------#
            #   Feature extraction using two convolutional normalized activation functions
            # ---------------------------------------------------#
            cls_feat = self.cls_convs[k](x)
            # ---------------------------------------------------#
            #   Determine the category to which the feature point belongs
            #   80, 80, num_classes
            #   40, 40, num_classes
            #   20, 20, num_classes
            # ---------------------------------------------------#
            ...
            # ---------------------------------------------------#
            #   Regression coefficients of characteristic points
            #   reg_pred 80, 80, 4
            #   reg_pred 40, 40, 4
            #   reg_pred 20, 20, 4
            # ---------------------------------------------------#
            ...
            # ---------------------------------------------------#
            #   Determine whether a feature point has a corresponding object
            #   obj_pred 80, 80, 1
            #   obj_pred 40, 40, 1
            #   obj_pred 20, 20, 1
            # ---------------------------------------------------#
