...
if __name__ == "__main__":
    ...
    mode = "predict"
    #-------------------------------------------------------------------------#
    # crop specifies whether the target is to be intercepted after a single image is predicted.
    ...
    #-------------------------------------------------------------------------#
    # heatmap_save_path heatmap save path, default save under model_data
    # heatmap_save_path
    # heatmap_save_path only valid for mode='heatmap'
    #-------------------------------------------------------------------------#
...
1、If you want to save the detected image, you can use r_image.save("img.jpg") to save it, and modify it directly in predict.py. 
        ...
        3, if you want to use the prediction box to intercept the target, you can enter the yolo.detect_image function, in the drawing part of the use of the four values obtained top, left, bottom and right.
        On the original map using the matrix of the way to intercept.
        4, if you want to write additional words on the predicted map, such as the number of specific targets detected, you can enter the yolo.detect_image function, in the plotting part of the predicted_class judgment, the
        For example, judge if predicted_class == 'car': that is, you can judge whether the current target is a car, and then record the number of can be. Use draw.text to write.
        '''
        while True:
