...
# ---------------------------------------------------------------------------#
# map_mode is used to specify what is calculated at runtime for this file
# map_mode is 0 for the entire map calculation process, including getting the prediction results and calculating the map.
# map_mode is 1 for just getting the prediction results.
# A map_mode of 2 means that only the map is computed.
# ---------------------------------------------------------------------------#
map_mode = 0
# -------------------------------------------------------#
