...
#-------------------------------------------------------#
# points to the path between the COCO training set and the validation set images
#-------------------------------------------------------#
train_datasets_path     = "coco_dataset/train2017"
val_datasets_path       = "coco_dataset/val2017"

#-------------------------------------------------------#
# points to the path between the COCO training set and the validation set labels
#-------------------------------------------------------#
